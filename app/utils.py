...
def getQstring(environ):
    """
    returns list of query parameter key-value pairs
    """
    qdict = {}
...
def dbSearch(searchstr):
    """
    searches the database for the string.
    """
    ...
    sql = """
SELECT name, age, nationality, club, photo, overall, value FROM Football.Players
WHERE name LIKE '%{}%' OR club LIKE '%{}%' OR nationality LIKE '%{}%';
    """.format(searchstr, searchstr, searchstr)
